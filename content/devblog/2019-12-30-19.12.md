...
Textures can be quite a lot of fun, and this martial arts scroll and several textures from **Sanuki** are no exception. Applying one of the custom [texture]({{ site.baseurl }}/assets/img/posts/19.12.01/SanukiMartialArtsScrollTexture.png) files adds elegance and character to this simple scroll.
