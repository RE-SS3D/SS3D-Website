...
<video autoplay="autoplay" muted loop="loop" width="580px" poster="/assets/img/posts/19.12.01/ProbablyNotSmoke.png">
  <source src="/assets/img/posts/19.12.01/ProbablyNotSmoke.mp4" type="video/mp4">
</video>

## Textures

Textures can be quite a lot of fun, and this martial arts scroll and several textures from **Sanuki** are no exception. Applying one of the custom [texture](/assets/img/posts/19.12.01/SanukiMartialArtsScrollTexture.png) files adds elegance and character to this simple scroll.
...
<video autoplay="autoplay" muted loop="loop" width="580px" poster="/assets/img/posts/19.12.01/CosmicPositronicBrain.png">
  <source src="/assets/img/posts/19.12.01/CosmicPositronicBrain.mp4" type="video/mp4">
</video>
...
{{ image(kind="post", src="assets/img/posts/19.12.01/SanukiX-RayLaserGun.png") }}
