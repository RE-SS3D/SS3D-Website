...
**Nath** has been working on the animation system, allowing for different items to be held, different poses (Sitting, crouching), interaction with tools/weapons, as well as interactions with hands.

While still a WIP, its a big step into getting our little spacemen to behaving more like spacemen. hello
