...
The updated animator's kit (v1.5) can be found here: **invalid link** (download the whole folder).
...
The updated modeler's kit (v2.0) can be found here: **invalid link** (download the whole folder).
