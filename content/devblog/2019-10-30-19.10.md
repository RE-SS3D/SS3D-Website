...
[Here's an infographic]({{ site.baseurl }}/assets/img/posts/19.10.01/EikoTileInfographic.png) courtesy of **Eiko** that describes how tiles are intended to work in RE:SS3D.
...
From **Eiko** this month: ambrosia, glass and mirrors, monkeystuff, seedpackets,  packages, cold hard cash, the gate, the PAI, and a poster model which properly displays [poster images]({{ site.baseurl }}/assets/img/posts/19.10.01/EikoEdPoster.png).
