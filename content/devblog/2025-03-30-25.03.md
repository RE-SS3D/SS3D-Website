...
So, we won't be disclosing specifics, to see those you will have to invade our {{ link(key="discord_url", text="Discord Server", path="") }}. However, we would like to briefly mention they we are currently working on the oh-so-important Animaiton & Atmospheric systems. Both of which have been major bottlenecks for this project.
